...
{
    std::cout << "Enter Window Coordinates:\n";
    ...
    std::cin >> p1.y; // if you don't know what value should be given: enter 200

    std::cout << "Enter P2(x,y):\n"; // P2(x,y) is the top right point for clipping window
    std::cin >> p2.x;                // if you don't know what value should be given: enter 400
    std::cin >> p2.y;                // if you don't know what value should be given: enter 400
    ...
    for (i = 0; i < n; i++)
    {
        std::cout << "\nEnter V" << i + 1 << "(x" << i + 1 << ",y" << i + 1 << "):\n";
        std::cin >> p[i].x; // if you don't know what value should be given: enter V1(100,110), V2(340,210), V3(300,380)
        std::cin >> p[i].y;
    }
